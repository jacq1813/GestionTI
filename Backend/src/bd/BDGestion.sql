...
(100) NOT NULL,
    FOREIGN KEY
(ID_TipEmp) REFERENCES TipoEmpleado
(ID_TipEmp)
);
...
(100) NOT NULL,
    ...
    ID_TipDpto INT,
    FOREIGN KEY
(ID_Emp) REFERENCES Empleado
(ID_Emp),
    FOREIGN KEY
(ID_TipDpto) REFERENCES TipoDepartamento
(ID_TipDpto)
);
...
(100) NOT NULL,
    ...
    ID_Emp INT,
    FOREIGN KEY
(ID_TipoAula) REFERENCES TipoAula
(ID_TipoAula),
    FOREIGN KEY
(ID_Edif) REFERENCES Edificio
(ID_Edif),
    FOREIGN KEY
(ID_Emp) REFERENCES Empleado
(ID_Emp)
...
(50),
    ...
    ID_TipEquipo INT,
    FOREIGN KEY
(ID_Aul) REFERENCES Aula
(ID_Aul),
    FOREIGN KEY
(ID_TipEquipo) REFERENCES TipoEquipo
(ID_TipEquipo)
);
...
(50),
    ...
    ID_TipComp INT,
    FOREIGN KEY
(ID_Equip) REFERENCES Equipo
(ID_Equip),
    FOREIGN KEY
(ID_TipComp) REFERENCES TipoComponente
(ID_TipComp)
);
...
(10),
    ...
    ID_Rec INT,
    FOREIGN KEY
(ID_Aula) REFERENCES Aula
(ID_Aul),
    FOREIGN KEY
(ID_Periodo) REFERENCES Periodos
(ID_Periodo),
    FOREIGN KEY
(ID_Emi) REFERENCES Empleado
(ID_Emp),
    FOREIGN KEY
(ID_Rec) REFERENCES Empleado
(ID_Emp)
);
...
(100),
    ID_Emp INT,
    FOREIGN KEY
(Folio_Incidencia) REFERENCES Incidencia
(Folio) ON
DELETE
SET NULL
,
...
REFERENCES SolucionIncidencia
(ID_Solucion) ON
DELETE CASCADE,
    FOREIGN KEY (ID_Causa)
REFERENCES CausaIncidencia
(ID_Causa) ON
DELETE CASCADE,
    FOREIGN KEY (ID_Emp)
REFERENCES Empleado
