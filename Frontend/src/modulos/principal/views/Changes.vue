<template>
    ...
    <div class="container">
        ...
        <h2>Registrar Cambio en la Bitácora</h2>
        ...
        <div class="top">
            ...
            <div class="grupo">
                ...
                <input type="text" :placeholder="selectedIncident?.Estado" disabled>
            </div>
            <div class="grupo">
        ...
        <div class="grupo">
            ...
            <select v-model="bitacora.Accion">
        ...
        <button class="btn btn-primary" @click="registrarCambio">Registrar Cambio</button>
    </div>
</template>
